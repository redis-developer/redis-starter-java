This is a [Redis](https://redis.io/) starter template for Java/Spring:

- [Redis Cloud](https://redis.io/try-free/)

## Requirements

- [Java (Version 17 or later)](https://www.oracle.com/java/technologies/downloads/)
- [Maven (Version 3.5 or later)](https://maven.apache.org/download.cgi)
